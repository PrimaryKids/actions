...
const toMetricDataPoint = (metricNameSpace, timeStamp, dataPoint) => ({
    series: [
        {
            host: 'lighthouse',
            type: 'gauge',
...
exports.toMetricDataPoint = toMetricDataPoint;
const pickReportScores = (jsReport) => Object.entries(METRIC_SCORE_MAP).map(([metricName, scorePath]) => ({
    metricName,
    value: (0, lodash_get_1.default)(jsReport, scorePath),
}));
const getScriptsSize = (jsReport) => jsReport.audits['network-requests'].details.items
    .filter((asset) => asset.resourceType === 'Script')
    .reduce((totalSize, asset) => totalSize + asset.transferSize, 0);
const scoresToDataPoints = (jsReport) => {
    return [
...
exports.scoresToDataPoints = scoresToDataPoints;
...
const reportUtils_1 = __nccwpck_require__(751);
const main = (namespace) => __awaiter(void 0, void 0, void 0, function* () {
    const jsonReports = yield (0, reportUtils_1.extractReportFileNames)();
    const promises = jsonReports.map((fileName) => __awaiter(void 0, void 0, void 0, function* () {
        const { timeStamp, dataPoints } = yield (0, reportUtils_1.parseResults)(fileName);
        return dataPoints.map((dataPoint) => {
            return (0, datadogUtils_1.sendMetric)((0, datadogUtils_1.toMetricDataPoint)(namespace, timeStamp, dataPoint));
        });
    }));
...
const parseResults = (fileName) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const dataPoints = (0, datadogUtils_1.scoresToDataPoints)(JSON.parse(report));
    return {
        timeStamp,
        dataPoints,
    };
